...
void firstIterationMMP1(MP5Parameters *mp5Parameters, DataParameters *dataParameters, GaborDictionary *gaborDictionary)
{
...
void nextIterationMMP1(MP5Parameters *mp5Parameters, DataParameters *dataParameters, GaborDictionary *gaborDictionary)
{
    unsigned long  int stepInToolbar, step = 0;
    unsigned short int channel;
    unsigned short int numberOfAnalysedChannels = mp5Parameters->numberOfAnalysedChannels;
