 ...
 ***************************************************************************/
	...
	void findAtomDataDotProduct(const Dictionary *dictionary, const MP5Parameters *mp5Parameters, Atom *currentAtom, const double *dataTable, unsigned short int channelNumber, unsigned char mode);
	STATUS findUnknowPhaseDI(Atom *currentAtom, double *modulus, unsigned short int channelNumber);
	STATUS findUnknowPhaseAM(Atom *currentAtom, double *modulus, unsigned short int numberOfAnalysedChannels);
